...
export default function AnnouncementForm({ editing, onClose, onSaved }) {
  ...
  return (
    <Modal onClose={onClose}>
      <div className="mc-scale-in bg-white/70 dark:bg-[#121220] border border-white/80 dark:border-[#c9a84c]/20 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] dark:shadow-none backdrop-blur-2xl transition-all rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
